...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
extern volatile int16_t position_1, position_2,position_3,position_4;
int current_encoder_1_count=0,current_encoder_2_count=0,current_encoder_3_count=0,current_encoder_4_count=0;
extern int speed_1, speed_2,speed_3, speed_4;
int PPR=13;

volatile int32_t last_encoder_1_count = 0,last_encoder_2_count = 0,last_encoder_3_count = 0,last_encoder_4_count = 0;
float elapsed_time;
